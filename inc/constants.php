...
$defaultoptions = array( 
    ...
    'url-newsletteranmeldung'		    => 'https://lists.piratenpartei.de/sympa/subscribe/newsletter',
    'anonymize-user'                => 0,
 ...
 $default_footerlink_liste = array(
     __( 'Germany', 'piratenkleider' )  => array(
        ...
        'sublist'   => array(
            ...
            __('Bavaria', 'piratenkleider' ) => 'https://piratenpartei-bayern.de/',
            ...
            __('Hamburg', 'piratenkleider' ) => 'http://piraten-hh.de/',
            __('Hesse', 'piratenkleider' ) => 'https://www.piratenpartei-hessen.de/',
            __('Mecklenburg-Vorpommern', 'piratenkleider' ) => 'http://piratenpartei-mv.de/',
            __('Lower Saxony', 'piratenkleider' ) => 'https://www.piraten-nds.de/',
            __('North Rhine-Westphalia', 'piratenkleider' ) => 'http://www.piratenpartei-nrw.de/',
            __('Rhineland-Palatinate', 'piratenkleider' ) => 'https://www.piraten-rlp.de/',
            __('Saarland', 'piratenkleider' ) => 'https://piratenpartei-saarland.de/',
            __('Saxony', 'piratenkleider' ) => 'https://piraten-sachsen.de/',
            __('Saxony-Anhalt', 'piratenkleider' ) => 'http://www.piraten-lsa.de/',
            __('Schleswig-Holstein', 'piratenkleider' ) => 'https://landesportal.piratenpartei-sh.de/',
            __('Thuringia', 'piratenkleider' ) => 'https://piraten-thueringen.de/'
        )
     ),
     __( 'Switzerland', 'piratenkleider' )  => array(
        'title' => __( 'Pirate Party Switzerland', 'piratenkleider' ),
        'url'   => 'https://www.piratenpartei.ch/',
        'sublist'   => array(
            'Aargau' => 'https://www.piraten-aargau.ch/',
            'Bern' => 'https://be.piratenpartei.ch/',
            'Beider Basel' => 'https://piraten-basel.ch/',
            'Genf' => 'https://ge.partipirate.ch/',
            'St. Gallen und beider Appenzell' => 'https://sg.partipirate.ch/',
            'Tessin' => 'https://www.partitopirata.ch/',
            'Thurgau-Schaffhausen' => 'https://tg.partipirate.ch/',
            'Waadt' => 'https://vd.partipirate.ch/',
            'Wallis' => 'https://vs.piratenpartei.ch/',
            'Zentralschweiz' => 'https://zs.piratenpartei.ch/',
            'Z&uuml;rich' => 'https://zh.piratenpartei.ch/',
        )
     ),
     __('International', 'piratenkleider' ) => array(
         ...
         'sublist' => array(
             __('Argentina', 'piratenkleider' ) => 'http://partidopirata.com.ar/',
             __('Australia', 'piratenkleider' ) => 'https://pirateparty.org.au/',
             __('Austria', 'piratenkleider' ) => 'https://www.piratenpartei.at/',
             __('Belarus', 'piratenkleider' ) => 'https://pirates.by/',            
             __('Beligium', 'piratenkleider' ) => 'https://pirateparty.be/',
             __('Brazil', 'piratenkleider' ) => 'http://partidopirata.org/',
             __('Canada', 'piratenkleider' ) => 'https://pirateparty.ca/',
             ...
             __('Czech Republic', 'piratenkleider' ) => 'https://www.pirati.cz/',
             __('Denmark', 'piratenkleider' ) => 'https://piratpartiet.dk/',
             ...
             __('Russia', 'piratenkleider' ) => 'https://pirate-party.ru/',
      ...
      __('International (with flags)', 'piratenkleider' ) => array(
         ...
         'url'  => 'https://pp-international.net/',
         'sublist' => array(
            '<span class="flagicon-ar"></span> '. __('Argentina', 'piratenkleider' ) => 'http://partidopirata.com.ar/',
            '<span class="flagicon-au"></span> '. __('Australia', 'piratenkleider' ) => 'https://pirateparty.org.au/',
            '<span class="flagicon-at"></span> '. __('Austria', 'piratenkleider' ) => 'https://www.piratenpartei.at/',
            '<span class="flagicon-by"></span> '. __('Belarus', 'piratenkleider' ) => 'https://pirates.by/',
            '<span class="flagicon-be"></span> '. __('Beligium', 'piratenkleider' ) => 'https://pirateparty.be/',
            '<span class="flagicon-br"></span> '. __('Brazil', 'piratenkleider' ) => 'http://partidopirata.org/',
            '<span class="flagicon-ca"></span> '. __('Canada', 'piratenkleider' ) => 'https://pirateparty.ca/',
            ...
            '<span class="flagicon-cz"></span> '. __('Czech Republic', 'piratenkleider' ) => 'https://www.pirati.cz/',
            '<span class="flagicon-dk"></span> '. __('Denmark', 'piratenkleider' ) => 'https://piratpartiet.dk/',
            ...
            '<span class="flagicon-gr"></span> '. __('Greece', 'piratenkleider' ) => 'https://www.pirateparty.gr/',
            ...
            '<span class="flagicon-is"></span> '. __('Iceland', 'piratenkleider') => 'http://piratar.is/',
            ...
            '<span class="flagicon-jp"></span> '. __('Japan', 'piratenkleider' ) =>  'http://ppt.3rin.net/',
            '<span class="flagicon-kz"></span> '. __('Kazakhstan', 'piratenkleider' ) => 'http://www.pirateparty.kz/',
            ...
            '<span class="flagicon-lu"></span> '. __('Luxembourg', 'piratenkleider' ) => 'http://piratepartei.lu/',
            ...
            '<span class="flagicon-ru"></span> '. __('Russia', 'piratenkleider' ) => 'https://pirate-party.ru/',
            ...
            '<span class="flagicon-es"></span> '. __('Spain', 'piratenkleider' ) => 'http://partidopirata.es/',
            ...
            '<span class="flagicon-tr"></span> '. __('Turkey', 'piratenkleider' ) => 'https://korsanparti.com/',
            ...
            '<span class="flagicon-us"></span> '. __('United States', 'piratenkleider' ) => 'https://pirate-party.us',
     ...
     'Baden-Wuerttemberg' => array(
         ...
         'url'  => 'https://piratenpartei-bw.de/',
         'sublist' => array(
             __('<abbr title="District Association">DA</abbr>','piratenkleider').' Freiburg' => 'https://bzv-fr.piratenpartei-bw.de/',
             __('<abbr title="District Association">DA</abbr>','piratenkleider').' Stuttgart' => 'https://wiki.piratenpartei.de/BW:Bezirksverband_Stuttgart',
             ...
             __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Karlsruhe' => 'http://www.piraten-karlsruhe.de/',
             __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Mittelbaden' => 'http://piraten-rastatt.de/',
             ...
             __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Ulm/Alb-Donau-Kreis' => 'http://piratenpartei-ulm.de/',            
         )
     ),  
     'Bayern' => array(
         'title' => __('Pirate Party Country Association','piratenkleider').' Bayern',
         'url'  => 'https://piratenpartei-bayern.de/',
         'sublist' => array(
             __('<abbr title="District Association">DA</abbr>','piratenkleider').' Mittelfranken' => 'https://piraten-mfr.de/',
             __('<abbr title="District Association">DA</abbr>','piratenkleider').' Oberbayern' => 'https://piraten-oberbayern.de/',
             __('<abbr title="District Association">DA</abbr>','piratenkleider').' Oberfranken' => 'https://piraten-oberfranken.de/',
             __('<abbr title="District Association">DA</abbr>','piratenkleider').' Oberpfalz' => 'https://www.piraten-oberpfalz.de/',
             __('<abbr title="District Association">DA</abbr>','piratenkleider').' Schwaben' => 'https://piraten-schwaben.de/',
             __('<abbr title="District Association">DA</abbr>','piratenkleider').' Unterfranken' => 'http://www.piraten-ufr.de/',
         ) 
     ), 
    'Brandenburg' => array(
        'title' => __('Pirate Party Country Association','piratenkleider').' Brandenburg',
        'url'  => 'https://www.piratenbrandenburg.de/',
        'sublist' => array(
            __('<abbr title="Town Chapter">TC</abbr>','piratenkleider').' Potsdam' => 'https://potsdam.piratenbrandenburg.org/',
    ...
    'Hamburg' => array(
        ...
        'url'  => 'http://piraten-hh.de/',
        'sublist' => array(
            __('<abbr title="District Association">DA</abbr>','piratenkleider').' Bergedorf' => 'http://bergedorf.piraten-hh.de/',
			__('<abbr title="District Association">DA</abbr>','piratenkleider').' Eimb&uuml;ttel' => 'http://eimsbuettel.piraten-hh.de/',
            __('<abbr title="District Association">DA</abbr>','piratenkleider').' Harburg' => 'http://harburg.piraten-hh.de/',
			__('<abbr title="District Association">DA</abbr>','piratenkleider').' Mitte' => 'http://mitte.piraten-hh.de/',
            __('<abbr title="District Association">DA</abbr>','piratenkleider').' Nord' => 'http://nord.piraten-hh.de/',
        )
    ),
    'Hessen' => array(
        'title' => __('Pirate Party Country Association','piratenkleider').' Hessen',
        'url'  => 'https://www.piratenpartei-hessen.de/',
        'sublist' => array(
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Bergstra&szlig;e' => 'https://www.piraten-bergstrasse.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Darmstadt / Darmstadt-Dieburg / Odenwald' => 'https://www.piratenpartei-dadadi.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Frankfurt am Main' => 'https://www.piratenpartei-frankfurt.de/',
			__('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Fulda' => 'https://www.piraten-fulda.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Gie&szlig;en' => 'https://www.piraten-giessen.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Gross-Gerau' => 'https://www.piratenpartei-gross-gerau.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Hochtaunus' => 'https://www.piratenpartei-hochtaunus.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Kassel' => 'https://www.piratenpartei-kassel.de/',
			__('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Kreis Offenbach' => 'https://www.kreispiraten-of.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Main-Kinzig' => 'https://www.kinzigpiraten.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Main-Taunus' => 'https://www.piraten-mtk.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Marburg-Biedenkopf' => 'https://www.piratenpartei-marburg.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Offenbach-Stadt' => 'http://www.stadtpiraten-offenbach.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Schwalm-Eder' => 'https://www.piraten-sek.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Waldeck-Frankenberg' => 'http://www.piraten-wa-fkb.net/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Wetterau' => 'https://www.piratenpartei-wetterau.de/',
     ...
     'Mecklenburg-Vorpommern' => array(
        ...
        'url'  => 'http://piratenpartei-mv.de/',
        'sublist' => array(
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Westmecklenburg' => 'http://www.piraten-westmecklenburg.de/',
            'Neubrandenburg' => 'http://piratenpartei-mv.de/partei/stammtische/neubrandenburg/',
            'Schwerin' => 'http://piratenpartei-mv.de/partei/stammtische/schwerin/',   
        )
    ),
   'Niedersachsen' => array(
        'title' => __('Pirate Party Country Association','piratenkleider').' Niedersachsen',
        'url' => 'https://www.piraten-nds.de/',
        'sublist' => array(
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Cloppenburg' => 'http://piratenpartei-clp.de/',
            __('<abbr title="Town Chapter">TC</abbr>','piratenkleider').' Delmenhorst' => 'http://piratenpartei-delmenhorst.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Diepholz' => 'http://www.piratenpartei-diepholz.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' G&ouml;ttingen' => 'https://www.piratenpartei-goettingen.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Hameln-Pyrmont' => 'https://piraten-hameln.de/',
            __('<abbr title="Regional Chapter">RC</abbr>','piratenkleider').' Hannover' =>'http://www.piratenhannover.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Niedersachsen-Nordost' => 'https://www.heide-piraten.de/',
            ...
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Oldenburg Land' => 'https://www.piraten-ol-land.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Stade' => 'https://piraten-stade.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Verden-Osterholz-Rotenburg' => 'http://www.piraten-verden.de/',
        )
    ),    
    'Nordrhein-Westfalen' => array(
      ...
      'sublist' => array(   
            ...
            'Bielefeld' => 'http://www.piraten-bielefeld.de/',
            'Bochum' => 'http://piratenbochum.de/',
            'Bonn' => 'http://piratenpartei-bonn.de/',
            'Dortmund' => 'http://www.piratenpartei-dortmund.de/',
            'Duisburg' => 'http://piratenpartei-duisburg.de/',
            'D&uuml;ren' => 'http://www.piratenpartei-dueren.de/',
            'D&uuml;sseldorf' => 'http://piratenpartei-duesseldorf.de',
            'Essen' => 'https://blog.piratenpartei-nrw.de/essen/',
            'Grevenbroich' => 'http://blog.piratenpartei-nrw.de/grevenbroich',
            'Hagen' => 'http://piratenhagen.org/',
            'Herne' => 'http://www.piraten-herne.de/',
            'HSK' => 'http://www.piratenpartei-hsk.de',
            'Iserlohn' => 'http://piraten-iserlohn.de/',
            'Kaarst' => 'https://blog.piratenpartei-nrw.de/kaarst/',
            'Kleve' => 'http://www.piratenpartei-kleve.de/',
            'K&ouml;ln' => 'http://www.piratenpartei-koeln.de/',
            'Krefeld' => 'http://www.seidenstadt-piraten.de/',
            'Kreis Steinfurt' => 'http://piraten-steinfurt.de/',
            'Leverkusen' => 'http://www.piratenpartei-leverkusen.de/',
            'Lippe' => 'http://www.piratenpartei-lippe.de',
            'M&ouml;nchengladbach' => 'http://crew.vituspiraten.de/',
            'M&uuml;nster' => 'http://www.piraten-muenster.de/',
            'Neuss' => 'http://www.neusser-piraten.de/',
            'Oberhausen' => 'http://piratenpartei-oberhausen.de/',
            'Ostwestfalen-Lippe' => 'https://blog.piratenpartei-nrw.de/owl/',
            'Paderborn' => 'http://www.piratenpartei-paderborn.de/',
            'Piratenfraktion NRW' => 'http://www.piratenfraktion-nrw.de/',
            'Rhein-Erft-Kreis' => 'http://piratenpartei-rhein-erft.de/',
            'Rhein-Sieg Kreis' => 'http://piratenpartei-rhein-sieg.de',
            'Schwerte' => 'https://blog.piratenpartei-nrw.de/schwerte/',
            'Siegen' => 'https://blog.piratenpartei-nrw.de/siegen/',
            'Soest' => 'http://www.piratenpartei-soest.de/',
            'Unna' => 'https://blog.piratenpartei-nrw.de/unna/',
            'Wesel' => 'http://piraten-kreiswesel.de',
          )
    ),
      'Rheinland-Pfalz' => array(
        'title' => __('Pirate Party Country Association','piratenkleider').' Rheinland-Pfalz',
        'url'  => 'https://www.piraten-rlp.de/',
        'sublist' => array(
            ...
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' S&uuml;dwestpfalz' => 'http://piraten-swp.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Trier/Trier-Saarburg' => 'http://www.piraten-trier.de/',
      ...
      'Sachsen' => array(
        ...
        'sublist' => array(
            ...
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Dresden' => 'https://www.piraten-dresden.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' G&ouml;rlitz' => 'http://www.piraten-goerlitz.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Leipzig' => 'http://piraten-leipzig.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Mei&szlig;en' => 'http://www.piraten-meissen.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Mittelsachsen' => 'http://mittelsachsen.piraten-sachsen.de/',
        )
    ),
      'Sachsen-Anhalt' => array(
        ...
        'sublist' => array(
            __('<abbr title="Regional Chapter">RC</abbr>','piratenkleider').' Altmark' => 'https://piraten-altmark.de/',
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' B&ouml;rde' => 'http://piraten-boerde.de/',
      ...
      'Thueringen' => array(
        ...
        'url'  => 'https://piraten-thueringen.de/',
        'sublist' => array(
            ...
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Erfurt' => 'http://piraten-erfurt.de/',
            ...
            __('<abbr title="District Chapter">DC</abbr>','piratenkleider').' Jena' => 'http://piraten-jena.de/',
        )
    ),
);
